...
ffmpeg -y -hide_banner -loglevel panic -filter_complex aevalsrc=0 -loop 1 -i $3/tmp/orders/$2/final.jpg -t 5.8 -framerate 25 -profile:v main -pix_fmt:v yuv420p -c:v libx264 -s 1920x1080 -b:v 10M $3/tmp/orders/$2/final.mp4
ffmpeg -y -hide_banner -loglevel panic -i $3/tmp/orders/$2/final.mp4 -i $3/tmp/sound.aac -map 0:v:0 -map 1:a:0 -ar 44100 -profile:v main -pix_fmt:v yuv420p -s 1920x1080 -c:v libx264 -b:v 10M -c:a aac -b:a 164k  $3/tmp/orders/$2/final.ts
...
# ffmpeg -y -hide_banner -i /home/debian/www/kinderhappynewyear.space/storage/tmp/orders/284573/final.mp4 -i /home/debian/www/kinderhappynewyear.space/storage/tmp/sound.aac -map 0:v:0 -map 1:a:0 -ar 44100 -profile:v main -pix_fmt:v yuv420p -s 1920x1080 -c:v libx264 -b:v 10M -c:a aac -b:a 164k /home/debian/www/kinderhappynewyear.space/storage/tmp/orders/284573/final.ts