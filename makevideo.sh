...
ffmpeg -y -hide_banner -loglevel panic -i $3/tmp/orders/$2/final.mp4 -i $3/tmp/sound.aac -map 0:v:0 -map 1:a:0 -b:a 164k -c:v libx264 -s 1920x1080 -b:v 10M  $3/tmp/orders/$2/final.ts
