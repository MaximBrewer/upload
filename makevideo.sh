...
ffmpeg -y -hide_banner -loglevel panic -loop 1 -i $3/tmp/orders/$2/final.jpg -t 5.8 -filter:v fps=fps=30 -profile:v main -pix_fmt:v yuv420p -c:v libx264 -s 1920x1080 -b:v 10M $3/tmp/orders/$2/final.mp4
